...
vim.keymap.set("n", "[d", vim.diagnostic.goto_prev({ float = false }), { desc = "Go to previous diagnostic" })
vim.keymap.set("n", "]d", vim.diagnostic.goto_next({ float = false }), { desc = "Go to next diagnostic" })
